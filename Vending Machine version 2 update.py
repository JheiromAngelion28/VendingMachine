...
vending_machine = {
    "Chips Spicy FLavor ":"0A", "Chips Onion Flavor":"0B",
    "Chips Tomato Flavor ":"0C", "Chips Brisket Flavor":"0D",
    "Instant Noodles Chicken Flavor":"0E", "Instant Noodles Beef Flavor":"0F",
    "Instant Noodles Shrimp Flavor":"0G", "Cocacola Soda":"1A",
    "Pepsi Soda":"1B", "Diet Coke Soda":"1C",
    "Chocolate Milk Shake":"1D","Strawberry Milk Shake":"1E",
    "Iced Tea":"1F", "gatorade Energy Drink ":"1G",
    "Evian Water":"2A", "Arwa Water":"2B",
    "Masafi ":"2C", "Figi Water":"2D", "Boba Milk Tea Caramel Flavor ":"2E",
    "Boba Milk Chocolate Milk Flavor":"2F", "Boba Milk Cheese Flavor":"2G"
}
...
prices = {
    "Chips Spicy FLavor (0A) ":"15AED", "Chips Onion Flavor (0B)":"15AED",
    "Chips Tomato Flavor (0C)":"15AED", "Chips Brisket Flavor (0D)":"15AED",
    "Instant Noodles Chicken Flavor (0E)":"10AED", "Instant Noodles Beef Flavor (0F)":"10AED",
    "Instant Noodles Shrimp Flavor (0G)":"10AED", "Cocacola Soda (1A)":"5AED",
    "Pepsi Soda (1B)":"5AED", "Diet Coke Soda (1C)":"5AED",
    "Chocolate Milk Shake (1D)":"10AED", "Strawberry Milk Shake (1E)":"10AED",
    "Iced Tea (1F)":"10AED", "Gatorade Energy Drink (1G)":"10AED",
    "Evian Water (2A)":"10AED", "Arwa Water (2B)":"1AED",
    "Masafi (2C)":"1AED", "Figi Water (2D)":"10AED",
...
def money_set (amount): #This is for setting the balance/money
    # We need to make this variable available/ accesible to other fuctions
    global money  
    money = amount
...
def purchase(reuired_money): #Used to help in traking the balance left to purchase
    global money
    #Using if else fuction to determine if you have enough balance or not 
...
def exchange_transaction(user_input): # Used to choose for the item and calls the purchase function above
    ...
    #I need to keep track of the items 
